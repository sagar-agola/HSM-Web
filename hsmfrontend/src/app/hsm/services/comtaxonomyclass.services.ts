...
@Injectable()
export class ComTaxonomyClassService {
    private controllerApi = `${AppSettings.SITE_HOST}/api/ComponentTaxonomyClasses`;
    ...
    getTaxonomyClassList(): Observable<any> {
        ...
        return this.http.get(`${url}/GetAllComponentTaxonomyClass`).pipe(
            map(res => {
    ...
    getTaxonomyClassByCategory(id: number): Observable<any> {
        ...
        return this.http.get(`${url}/GetComTaxonomyClassByCategory/${id}`).pipe(
            map(res => {
    ...
    addTaxonomyClass(taxClassObject: IComTaxonomyClass): Observable<IComTaxonomyClass>{
        return this.http.post(this.controllerApi, taxClassObject).pipe(
            map(res => {
                return res as IComTaxonomyClass
            }));
    }
