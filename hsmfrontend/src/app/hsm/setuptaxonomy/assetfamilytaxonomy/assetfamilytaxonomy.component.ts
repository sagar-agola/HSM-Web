...
import { AssetHierarchyFamilyModalComponent } from '../../modal/assetfamilytaxonomymodal/assetfamilytaxonomymodal.component';

@Component({
    selector: "asset-family",
    templateUrl: './assetfamilytaxonomy.component.html',
    styleUrls: [
        './assetfamilytaxonomy.component.scss'
    ]
})

export class AssetHierarchyFamilyTaxonomyComponent implements OnInit {

    @ViewChild(MatPaginator, {static: true}) paginator: MatPaginator;
    @ViewChild(MatSort, {static: true}) sort: MatSort;
    @ViewChild('TABLE', {static: true}) table: ElementRef;

    displayedColumns = ['id', 'componentFamilies', 'edit', 'delete'];

    ELEMENT_DATA: IAssetHierarchyComponentFamilyTaxonomy[] = [];
    ...
    getDataSource(): void{
        this._assetHierarchyFamilyService.getAssetFamilyTaxonomy()
          .subscribe(res => {
            this.default = false;
            this.loading = false;
            this.ELEMENT_DATA = res;
            this.dataSource = new MatTableDataSource<IAssetHierarchyComponentFamilyTaxonomy>(this.ELEMENT_DATA);
    ...
    openDialogFamily(opt: string, data: any) {
        ...
        const dialogRef = this.dialog.open(AssetHierarchyFamilyModalComponent, dialogConfig);
    ...
    deleteAction(id: number, name: string): void {
        if (confirm("Are you sure to delete " + name + " ? This cannot be undone.")) {
            this._assetHierarchyFamilyService.deleteAssetFamilyTaxonomy(id)
            .subscribe(res => {    
