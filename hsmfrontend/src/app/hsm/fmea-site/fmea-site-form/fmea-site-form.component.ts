...
import { IFMEA, IFMEASite, IFMUFTSite } from './../../interfaces/IFMEA';
...
//helpers
import { fmeaDefault, fmuftSiteDefault } from '../../../shared/helpers/default.helpers';
...
@Component({
    selector: "fmea-site-form",
    templateUrl: './fmea-site-form.component.html',
    styleUrls: [
        './fmea-site-form.component.scss'
    ]
})

export class FMEASiteFormComponent implements OnInit {
    ...
    saveChanges(){
        ...
        this.fmuftService.addFMUFTSite(this.fmeaObject)
            .subscribe(res =>{
                console.log(res);
                this.isLocked = true;
                // this.fmeaObject.taskIdentificationNo = "FFT.000.00" + res.id;
                this.fmeaObject.id = res.id;
                this.fmuftService.updateFMUFTSite(this.fmeaObject.id, this.fmeaObject)
                    .subscribe(out => {
