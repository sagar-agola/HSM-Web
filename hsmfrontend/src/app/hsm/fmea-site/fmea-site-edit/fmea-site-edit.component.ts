...
import { IFMEA, IFmeaAssembly, IFMUFTSite } from '../../interfaces/IFMEA';
...
import { fmeaAssemblyDefault, fmeaDefault, fmuftSiteDefault } from 'src/app/shared/helpers/default.helpers';
...
@Component({
    selector: "fmea-site-edit",
    templateUrl: './fmea-site-edit.component.html',
    styleUrls: [
        './fmea-site-edit.component.scss'
    ]
})

export class FMEASiteEditComponent implements OnInit {
    ...
    constructor(
        ...
        private fmuftService: FMaintainableUnitService,
    ...
    ngOnInit(): void {
        ...
        this.siteId = user?.users?.group?.siteId === 0 || user?.users?.group?.siteId === null ? 0 : user?.users?.group?.siteId;

        this.fmeaObject.siteId = this.siteId;
        this.fmeaObject.customerId = this.customerId;
        // console.log(this.statusList)
        this.fmuftService.getFMUFTSiteLastNumber()
          .subscribe(out => {
        ...
        forkJoin(
            ...
            this.fmuftService.getFMUFTSiteById(this.currentId),
    ...
    initializeFieldData(data: IFMUFTSite): void {
        ...
        this.fmeaObject.updatedBy = this.updatedBy;
    ...
    onExit(): void{
        this.router.navigate(["/main/site-component-task-list"]);
    }
    ...
    openDialogComment(mode: any, param: number) {
        ...
        dialogConfig.data = {mode: mode, id: param, item: this.fmeaObject };
    ...
    saveChanges(){
        ...
        this.fmuftService.updateFMUFTSite(this.currentId, this.fmeaObject)
            .subscribe(out => {
                console.log(out);
