...
@Component({
    selector: "ctaxonomy-class",
    templateUrl: './ctaxonomyclass.component.html',
    styleUrls: [
        './ctaxonomyclass.component.scss'
    ]
})

export class CompTaxonomyClassComponent implements OnInit {
    ...
    ELEMENT_DATA: IComTaxonomyClass[] = [];
    ...
    constructor(
        ...
        private _taxonomyClassService: ComTaxonomyClassService
    ) {
    }
    ...
    getDataSource(): void{
        this._taxonomyClassService.getTaxonomyClassList()
          .subscribe(res => {
            ...
            this.dataSource = new MatTableDataSource<IComTaxonomyClass>(this.ELEMENT_DATA);
    ...
    openDialogCategory(opt: string, data: any) {
        ...
        const dialogRef = this.dialog.open(CTaxonomyClassModalComponent, dialogConfig);
