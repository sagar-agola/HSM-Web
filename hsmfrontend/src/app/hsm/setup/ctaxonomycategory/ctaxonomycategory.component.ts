...
import { CTaxonomyCategoryModalComponent } from '../../modal/ctaxonomycategorymodal/ctaxonomycategorymodal.component';

@Component({
    selector: "ctaxonomy-category",
    templateUrl: './ctaxonomycategory.component.html',
    styleUrls: [
        './ctaxonomycategory.component.scss'
    ]
})

export class CompTaxonomyCategoryComponent implements OnInit {
    ...
    ELEMENT_DATA: IComTaxonomyCategory[] = [];
    ...
    constructor(
        ...
        private _taxonomyCategoryService: ComTaxonomyCategoryService
    ) {
    }
    ...
    getDataSource(): void{
        this._taxonomyCategoryService.getTaxonomyCategory()
          .subscribe(res => {
            ...
            this.dataSource = new MatTableDataSource<IComTaxonomyCategory>(this.ELEMENT_DATA);
    ...
    openDialogCategory(opt: string, data: any) {
        ...
        const dialogRef = this.dialog.open(CTaxonomyCategoryModalComponent, dialogConfig);
