...
//interface
import { IAddHierarchyToTask, IAssetTaskGroupStrategy, IAssetTaskGroupStrategyHsm, IAssignAssetTaskGroupStrategyHierarchy, IAssignAssetTaskGroupStrategyMaterial, IAssignAssetTaskGroupStrategyMaterialView, IAssignTaskToEquipment, IAssignTaskToEquipmentList } from './../../interfaces/IAssetTaskGroupStrategy';
...
@Component({
  selector: "asset-task-group-hsm-edit",
  templateUrl: './assettaskgroupstrategyhsmedit.component.html',
  styleUrls: [
      './assettaskgroupstrategyhsmedit.component.scss'
  ]
})

export class AssetTaskGroupHsmEditComponent implements OnInit {
  ...
  transactionTypeList: any = [
    ...
    ngOnInit(): void {
      ...
      this._assetTaskGroupStrategyHsmService.getAssetTaskGroupStrategyLastRow()
        .subscribe(foo => {
          // console.log(foo)
      ...
      this._assetTaskGroupStrategyHsmService.getAssetTaskGroupStrategyLastNumber()
          .subscribe(out => {
      ...
      if(fmeadata){
        ...
        forkJoin(
          ...
          this._categoryHierarchyService.getComponentCategoryHierarchyLevel1(),
          this._componentTaskService.getAllFMMTByCustomerSiteId(this.customerId, this.siteId),
          this._assetTaskGroupStrategyHsmService.getAssetTaskGroupStrategyById(this.currentId),
          this._fmeaService.getSystemStatus(),
              ...
              this.assetClassList = ch;
              this.maintUnitList = mu.filter(e=> e.customerId === 0 && e.siteId === 0);
    ...
    initializeFieldData(data: IAssetTaskGroupStrategyHsm): void {
      ...
      forkJoin(
        ...
        this._categoryHierarchyService.getComponentById(this.assetClassId),
  ...
  getAssetClassId(id: number){
    this._categoryHierarchyService.getComponentById(id)
        .subscribe(res => {
            ...
            this._assetTaskGroupStrategyHsmService.getAssetClassHierarchy(this.componentCode)
              .subscribe(foo => {
                  // console.log(foo)
  ...
  updateChanges(): void{
    ...
    this._assetTaskGroupStrategyHsmService.updateStrategyGroup(this.currentId, this.assetTaskGroupStrategyObject)
      .subscribe(res => {
        this.isSave = true;
  ...
  openAttachTask(opt: string, data: any) {
    ...
    const dialogRef = this.dialog.open(AttachTaskModalComponent, dialogConfig);
  ...
  SaveAll(): void{
    ...
    this._assignAssetTGSMaterialHsmService.upsertAssignAssetMaterial(this.materialHsmList)
      .subscribe(res => {
        // console.log("success");
        // this.toastr.success("Successfully saved!", 'Success');
        localStorage.removeItem("modalcomponentList");
  ...
  // deleteTask(category: any): void{
  //   if (confirm("Are you sure to delete this ? This cannot be undone.")) {
  //     var index = this.result.map(x => {
  //       return x.categoryName;
  //     }).indexOf(category);
  
  //     this.result.splice(index, category);
  ...
  deleteTaskSaved(id: number): void{
    if (confirm("Are you sure to delete this ? This cannot be undone.")) {
      this._assignAssetTGSMaterialHsmService.deleteAssignTGS(id)
      .subscribe(res => {
          this.getTGSTasks();
      });
    }
