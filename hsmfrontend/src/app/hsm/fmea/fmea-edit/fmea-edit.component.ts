...
@Component({
    selector: "fmea-edit",
    templateUrl: './fmea-edit.component.html',
    styleUrls: [
        './fmea-edit.component.scss'
    ]
})

export class FMEAEditComponent implements OnInit {
    ...
    deleteFMEA(): void {
        ...
        if (confirm("Are you sure to delete " + this.componentTask + " ? This cannot be undone.")) {
            this._fmeaService.deleteFMEA(this.currentId)
            .subscribe(out => {
