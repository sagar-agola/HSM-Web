...
import { ImportFmeaSiteMatchModalComponent } from '../importfmeasitematchmodal/importfmeasitematchmodal.component';

//Services


@Component({
  selector: 'importfmeasite-modal',
  templateUrl: './importfmeasitemodal.component.html',
  styleUrls: ['./importfmeasitemodal.component.scss']
})

export class ImportFmeaSiteModalComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ImportFmeaSiteModalComponent>,
        @Inject(MAT_DIALOG_DATA) public data: any,
        public dialog: MatDialog,
        public toastr: ToastrService,
        private _fmeaService: FMaintainableUnitService,
    ...
    onFileChange(event: any) {
     ...
     openDialogMatch(data: any, val: any) {
        ...
        const dialogRef = this.dialog.open(ImportFmeaSiteMatchModalComponent, dialogConfig);
