...
@Component({
  selector: 'create-new-fmea-site-modal',
  templateUrl: './createnewfmeasitemodal.component.html',
  styleUrls: ['./createnewfmeasitemodal.component.scss']
})

export class CreateNewFMEASiteModalComponent implements OnInit {
    public data: [];
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<CreateNewFMEASiteModalComponent>,
    ...
    ngOnInit(): void {
        ...
        forkJoin(
            ...
            this._componentTaskService.getComponentTaskById(this.node.item),
                ...
                this.taxonomyFamilyList = ct.filter(e=> e.siteId !== 0 && e.customerId !== 0);
                this.taxonomyClassList = cl.filter(e=> e.siteId !== 0 && e.customerId !== 0);
                this.taxonomySubClassList = tp.filter(e=> e.siteId !== 0 && e.customerId !== 0);
                this.taxonomyBuildSpecList = th.filter(e=> e.siteId !== 0 && e.customerId !== 0);
                this.taxonomyManufacturerList = mt.filter(e=> e.siteId !== 0 && e.customerId !== 0);
                // console.log(tt)
    ...
    manufacturerOnselect(event){
        ...
        this._manufacturerTaxonomyService.getComponentManufacturerById(this.manufacturerId)
            .subscribe(res => {
                this.manufacturerName = res.assetManufacturer;
                this.manufacturerName= (res.assetManufacturer != null || res.assetManufacturer != undefined) ? res.assetManufacturer: "";
            })
    }
