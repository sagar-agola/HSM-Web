...
import { ImportReviewModalComponent } from '../importreviewmodal/importreviewmodal.component';
...
@Component({
  selector: 'importmatch-modal',
  templateUrl: './importmatchmodal.component.html',
  styleUrls: ['./importmatchmodal.component.scss']
})

export class ImportmatchModalComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ImportmatchModalComponent>,
    ...
    ngOnInit(): void {
        ...
        this.fmeaService.getOptions(this.tblname)
            .subscribe(res => { 
                // console.log(res)
                this.optionList = res; 
        });
    ...
    openDialogReview(data: any, val: any) {
        ...
        const dialogRef = this.dialog.open(ImportReviewModalComponent, dialogConfig);
