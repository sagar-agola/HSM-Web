...
@Component({
  selector: 'ctaxonomycategory-modal',
  templateUrl: './ctaxonomycategorymodal.component.html',
  styleUrls: ['./ctaxonomycategorymodal.component.scss']
})

export class CTaxonomyCategoryModalComponent implements OnInit {
    mode: string = "";
    category: string = "";
    currentId: number;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<CTaxonomyCategoryModalComponent>,
