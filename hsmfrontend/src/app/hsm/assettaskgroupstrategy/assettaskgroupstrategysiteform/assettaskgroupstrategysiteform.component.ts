...
@Component({
    selector: "site-task-group-form",
    templateUrl: './assettaskgroupstrategysiteform.component.html',
    styleUrls: [
        './assettaskgroupstrategysiteform.component.scss'
    ]
})

export class AssetTaskGroupStrategySiteFormComponent implements OnInit {
    ...
    maintUnitOnSelect(event){
      ...
      this._componentTaskService.getComponentTaskById(this.maintUnitId)
        ...
        this._comClassTaxonomyService.getComponentTaxonomyClassesByIds(this.maintUnitId, this.customerId, this.siteId)
            .subscribe(out => {
              // console.log(out, this.maintUnitId, this.customerId, this.siteId)
